...
latex_documents = [
    (
        ...
        "LUE.tex",
        "LUE Documentation",
        "Kor de Jong, Oliver Schmitz, Merijn de Bakker, Derek Karssenberg",
        "manual",
    ),
]
...
man_pages = [(master_doc, "lue", "LUE Documentation", [author], 1)]
...
def can_access_python_extension():
    return (
        "LUE" in os.environ
        and "OBJECTS" in os.environ
        and "MY_DEVENV_BUILD_TYPE" in os.environ
    )
