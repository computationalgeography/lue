...
static std::string const datatype_tag =
    "lue_datatype";
static std::string const nr_objects_tag =
    "lue_nr_objects";
...
static std::string const object_tracker_tag =
    "lue_object_tracker";
static std::string const object_id_tag =
    "lue_object_id";
static std::string const active_object_id_tag =
    "lue_active_object_id";
static std::string const active_set_index_tag =
    "lue_active_set_index";
static std::string const active_object_index_tag =
    "lue_active_object_index";
static std::string const coordinates_tag =
    "lue_coordinates";
static std::string const nr_locations_in_time_tag =
...
static std::string const same_shape_variable_shape_tag =
    "lue_same_shape_variable_shape";
static std::string const different_shape_tag =
    "lue_different_shape";
...
// static std::string const space_discretization_tag =
//     "lue_space_discretization";
// static std::string const space_domain_type_tag =
//     "lue_space_domain_type";
// 
// static std::string const time_discretization_tag =
//     "lue_time_discretization";
// static std::string const time_domain_tag =
