...
// 
// 
//     py::class_<PropertySets, PhenomenonCollection>(
//         module,
//         "PropertySets",
//         R"(
...
//     collection.
// 
//     It is not possible to create PropertySets instances from scratch:
...
// 
    ...
    py::class_<PropertySets, hdf5::Group>(
        module,
        "Phenomenon",
        R"(
