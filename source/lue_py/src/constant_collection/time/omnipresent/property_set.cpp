#include "lue/py/constant_collection/time/omnipresent/property.hpp"
    ...
    py::module& module)
{
    ...
    py::class_<PropertySet, constant_collection::PropertySet>(
        module,
        "PropertySet",
        ...
        //     "add_property",
        //     [](
        //         lue::constant_collection::time::omnipresent::PropertySet& self,
        //         std::string const& name,
        //         py::handle const& numpy_type_id_object,
        //         py::tuple const& shape,
        //         py::tuple const& chunks) ->
        //             lue::constant_collection::time::omnipresent::same_shape::Property&
        //     {
        ...
        //             py::handle const& numpy_type_id_object,
        //             size_t const rank) ->
        //                 lue::constant_collection::time::omnipresent::different_shape::Property& {
