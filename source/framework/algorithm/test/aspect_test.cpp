...
BOOST_AUTO_TEST_CASE(use_case_1)
{
    ...
    auto aspect_we_want = lue::test::create_partitioned_array<Array>(
        shape,
        shape,
        {{
            3.93, 4.9,  5.11,  nd,    5.77, 0.785, 4.96, 5.06, nd,    nd,  0.326, 6.25, 5.36,
            5.02, 5.38, 0.086, 0.228, 6.25, 5.58,  5.65, 6.28, 0.497, 0.1, 5.65,  5.83,
        }});
