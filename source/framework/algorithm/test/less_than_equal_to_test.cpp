...
namespace detail {
    ...
    void test_array()
    {
        ...
        {
            BOOST_CHECK(all(array1 <= array2).future().get());
            BOOST_CHECK(none(array2 <= array1).future().get());
        }
        ...
        // array <= scalar
        {
            BOOST_CHECK(all(array1 <= fill_value2).future().get());
            BOOST_CHECK(none(array2 <= fill_value1).future().get());
        }
