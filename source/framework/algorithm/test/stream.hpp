...
namespace lue {
    ...
    std::ostream& operator<<(std::ostream& stream, InterPartitionStreamMaterial<Index, rank> const& material)
    {
    ...
    std::ostream& operator<<(
        std::ostream& stream, detail::ArrayPartitionIO<Index, rank, Value> const& partition_io)
    {
