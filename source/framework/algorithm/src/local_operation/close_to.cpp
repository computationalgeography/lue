...
#define LUE_INSTANTIATE(OutputElement, InputElement, rank)                                                   \
    ...
    LUE_INSTANTIATE_BINARY_LOCAL_OPERATION(                                                                  \
        ESC(policy::close_to::DefaultPolicies<OutputElement, InputElement>),                                 \
        OutputElement,                                                                                       \
        InputElement,                                                                                        \
        InputElement,                                                                                        \
        rank,                                                                                                \
        ESC(detail::CloseTo<InputElement, OutputElement>));                                                  \
                                                                                                             \
    LUE_INSTANTIATE_BINARY_LOCAL_OPERATION(                                                                  \
        ESC(policy::close_to::DefaultValuePolicies<OutputElement, InputElement>),                            \
        OutputElement,                                                                                       \
        InputElement,                                                                                        \
        InputElement,                                                                                        \
        rank,                                                                                                \
