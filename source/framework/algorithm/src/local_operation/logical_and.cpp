...
#define LUE_INSTANTIATE(OutputElement, InputElement, rank)                                     \
    ...
    LUE_INSTANTIATE_BINARY_LOCAL_OPERATION(                                                    \
        ESC(policy::logical_and::DefaultPolicies<OutputElement, InputElement>),                \
        OutputElement,                                                                         \
        InputElement,                                                                          \
        InputElement,                                                                          \
        rank,                                                                                  \
        ESC(detail::LogicalAnd<InputElement, OutputElement>));                         \
                                                                                               \
    LUE_INSTANTIATE_BINARY_LOCAL_OPERATION(                                                    \
        ESC(policy::logical_and::DefaultValuePolicies<OutputElement, InputElement>),           \
        OutputElement,                                                                         \
        InputElement,                                                                          \
        InputElement,                                                                          \
        rank,                                                                                  \
