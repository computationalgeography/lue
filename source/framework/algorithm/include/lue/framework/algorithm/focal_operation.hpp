...
namespace lue {
    ...
    namespace detail {
            ...
            Array<DynamicSubspan<Element, rank<Kernel>>, rank<Kernel>> const&... windows)
        {
            ...
            return inner(functor, kernel,
                output_policies, input_policies, std::index_sequence_for<Element...>{},
        ...
        namespace meh {
            ...
            template<
                typename WrappedArrayPartitions,
                typename... Idxs>
            auto const& input_partition_data(
                WrappedArrayPartitions const& input_partitions,
                Idxs const... idxs)
            {
                // Future<Data>
                ...
                WrappedArrayPartitions<InputPolicies, InputPartitions> const&... input_partitions)
            {
                ...
                // partition
                std::tuple<WrappedArrayPartitions<InputPolicies, InputPartitions>...> input_partitions_tuple{input_partitions...};
            ...
            Functor const& functor)
        {
            return focal_operation_partition2<Policies, OutputPartition, Kernel, Functor, InputPartitions...>(
                policies, std::index_sequence_for<InputPartitions...>(), input_partitions...,
                kernel, functor);
        }
        ...
        struct FocalOperationPartitionAction:
            hpx::actions::make_action<
                decltype(&focal_operation_partition<Policies, OutputPartition, Kernel, Functor, InputPartitions...>),
                &focal_operation_partition<Policies, OutputPartition, Kernel, Functor, InputPartitions...>,
                FocalOperationPartitionAction<Policies, OutputPartition, Kernel, Functor, InputPartitions...>>::type
        {};
            ...
            return hpx::when_all(detail::when_all_get(std::move(input_partitions))...).then(hpx::util::unwrapping(
                        ...
                        hpx::util::tuple<hpx::lcos::future<InputPartitions>...>&& input_partitions)
                    {
                        ...
                        auto call_action = [locality_id, action, policies, kernel, functor](
                                InputPartitions&&... input_partitions)
                            {
                                return action(locality_id, policies, std::move(input_partitions)..., kernel, functor);
                            };
            ...
            WrappedPartitionedArray<InputPolicies, InputElements> const&... input_arrays)
        {
            ...
            FocalOperationPartitionAction<
                Policies, OutputPartition, Kernel, Functor,
            ...
            output_partitions(0, 0) = spawn_focal_operation_partition(
               localities(0, 0),
               action, policies, kernel, functor, meh::north_west_corner_input_partitions(input_arrays)...);

            if(nr_partitions1 > 1)
            {
                output_partitions(0, nr_partitions1 - 1) = spawn_focal_operation_partition(
                   localities(0, nr_partitions1 - 1),
                   action, policies, kernel, functor, meh::north_east_corner_input_partitions(input_arrays)...);
            }
            ...
            if(nr_partitions0 > 1)
            {
                output_partitions(nr_partitions0 - 1, 0) = spawn_focal_operation_partition(
                   ...
                   action, policies, kernel, functor, meh::south_west_corner_input_partitions(input_arrays)...);
            }
            ...
            if(nr_partitions0 > 1 && nr_partitions1 > 1)
            {
                output_partitions(nr_partitions0 - 1, nr_partitions1 - 1) = spawn_focal_operation_partition(
                    ...
                    action, policies, kernel, functor, meh::south_east_corner_input_partitions(input_arrays)...);
            }
            ...
            for(Index c = 1; c < nr_partitions1 - 1; ++c)
            {
                output_partitions(0, c) = spawn_focal_operation_partition(
                   localities(0, c),
                   action, policies, kernel, functor, meh::north_side_input_partitions(c, input_arrays)...);
            }
            ...
            if(nr_partitions0 > 1)
            {
                for(Index c = 1; c < nr_partitions1 - 1; ++c)
                {
                    output_partitions(nr_partitions0 - 1, c) = spawn_focal_operation_partition(
                        ...
                        action, policies, kernel, functor, meh::south_side_input_partitions(c, input_arrays)...);
                }
            }
            ...
            for(Index r = 1; r < nr_partitions0 - 1; ++r)
            {
                output_partitions(r, 0) = spawn_focal_operation_partition(
                    localities(r, 0),
                    action, policies, kernel, functor, meh::west_side_input_partitions(r, input_arrays)...);
            }
            ...
            if(nr_partitions1 > 1)
            {
                for(Index r = 1; r < nr_partitions0 - 1; ++r)
                {
                    output_partitions(r, nr_partitions1 - 1) = spawn_focal_operation_partition(
                        ...
                        action, policies, kernel, functor, meh::east_side_input_partitions(r, input_arrays)...);
                }
            }
            ...
            for(Index r = 1; r < nr_partitions0 - 1; ++r) {
                for(Index c = 1; c < nr_partitions1 - 1; ++c)
                {
                    output_partitions(r, c) = spawn_focal_operation_partition(
                        localities(r, c),
                        action, policies, kernel, functor, meh::inner_input_partitions(r, c, input_arrays)...);
                }
            }
            ...
            PartitionedArray<InputElements, rank<Kernel>> const&... input_arrays)
        {
            ...
            return focal_operation_2d(policies, kernel, functor,
                WrappedPartitionedArray{
