    ...
    return hpx::dataflow(
        ...
        hpx::unwrapping(
                ...
                [input_partition, policies, functor](
                    Offset const& offset,
                    InputData const& input_partition_data) mutable
                {
                    ...
                    OutputPartition output_partition{hpx::find_here(),
                        offset_in_partitions(offset, input_partition_data.shape()), {1, 1}, result};
...
struct PartitionAggregateOperationPartitionAction:
    hpx::actions::make_action<
            ...
            &partition_aggregate_operation_partition<
                Policies, InputPartition, OutputPartition, Functor>,
    ...
    Functor const& functor)
{
    ...
    detail::PartitionAggregateOperationPartitionAction<
