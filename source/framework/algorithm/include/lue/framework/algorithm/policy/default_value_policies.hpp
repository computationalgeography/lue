...
namespace lue::policy {
    ...
    using DefaultInputNoDataPolicy = std::conditional_t<
    ...
    template<typename Element>
    using DefaultOutputNoDataPolicy = std::conditional_t<
        std::is_floating_point_v<Element>,
    ...
    template<typename DomainPolicy, typename OutputElements, typename InputElements>
    ...
    */
...

    {
        ...
        private:
            ...
            using Base = Policies<
                DomainPolicy,
                lue::policy::OutputsPolicies<lue::policy::OutputPolicies<
                    DefaultOutputNoDataPolicy<OutputElements>,
                    AllValuesWithinRange<OutputElements, InputElements...>>...>,
                lue::policy::InputsPolicies<SpatialOperationInputPolicies<
                    DefaultInputNoDataPolicy<InputElements>,
                    FillHaloWithConstantValue<InputElements>>...>>;
        ...
        public:
            ...
            DefaultSpatialOperationValuePolicies(InputElements const... fill_values):
