...
namespace lue {
    ...
    namespace value_policies {
            ...
            PartitionedArray<Element, rank> const& false_array)
        {
            ...
            using Policies = policy::where::DefaultValuePolicies<Element, ConditionElement, Element, Element>;
            ...
            PartitionedArray<Element, rank> const& true_array)
        {
            ...
            using Policies = policy::where::DefaultValuePolicies<Element, ConditionElement, Element>;
