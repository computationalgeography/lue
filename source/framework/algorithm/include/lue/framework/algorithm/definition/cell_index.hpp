...
namespace lue {
    ...
    //
    //
    //                     void set_downstream_components(std::map<hpx::id_type, ComponentClient>&&
    //                     components)
    //                     {
    ...
    //
    //         template<typename Policies, Rank rank>
    //         class Walk: public hpx::components::client_base<Walk<Policies, rank>, server::Walk<Policies,
    //         rank>>
    //         {
    //
    //             private:
