...
// ArrayPartition<bool, 1>
//     equal_to_partition2(
//         ArrayPartition<std::int32_t, 1> const& partition1,
//         ArrayPartition<std::int32_t, 1> const& partition2)
// {
//     using Value = std::int32_t;
//     std::size_t const rank = 1;
//     using Data = ArrayPartitionData<Value, rank>;
//     // using ArrayPartition = ArrayPartition<Value, Data>;
// 
...
//         {
//             return
//                 ArrayPartition<bool, ArrayPartitionData<bool, rank>>(
