...
namespace lue {
    ...
    template<typename InputElement, typename OutputElement = InputElement, Rank rank>
    hpx::future<OutputElement> sum(PartitionedArray<InputElement, rank> const& array)
    {
