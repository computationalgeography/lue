...
namespace lue::benchmark {
    ...
    class AccuThresholdBenchmarkModel final: public BenchmarkModel<MaterialElement, 2>
    {
        ...
        public:
...

            {
                ...
                hdf5::Offset start{
                    center_cell[0] - (array_shape[0] / 2), center_cell[1] - (array_shape[1] / 2)};
            ...
            void do_simulate([[maybe_unused]] Count const time_step) override
            {
                ...
                std::tie(std::ignore, this->state()) =
                    accu_threshold(Policies{}, _flow_direction, _material, _threshold);
            }
