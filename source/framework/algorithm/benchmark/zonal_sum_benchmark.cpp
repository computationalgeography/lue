...
namespace lue {
    namespace benchmark {
        ...
        class ZonalSumBenchmark: public BenchmarkModel<Element, rank>
        {
            ...
            public:
                ...
                ZonalSumBenchmark(Task const& task, std::size_t max_tree_depth);
                ...
                ZonalSumBenchmark& operator=(ZonalSumBenchmark const&) = default;

                ZonalSumBenchmark& operator=(ZonalSumBenchmark&&) = default;
        ...
        template<typename Element, std::size_t rank>
        void ZonalSumBenchmark<Element, rank>::do_simulate(Count const /* time_step */)
        {
            // Distribute zones
