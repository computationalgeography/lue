...
#define LUE_REGISTER_ARRAY_PARTITION_ACTIONS(Element, rank)                                                  \
                                                                                                             \
    HPX_REGISTER_COMPONENT(                                                                                  \
        hpx::components::component<ArrayPartition_##Element##_##rank##_Component>,                           \
...
#define LUE_REGISTER_ARRAY_PARTITIONS_ACTIONS(Element)                                                       \
                                                                                                             \
