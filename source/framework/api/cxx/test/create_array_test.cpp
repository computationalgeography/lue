...
BOOST_AUTO_TEST_CASE(create_array)
{
    ...
    lue::Field const fill_value = Element{};

    lue::Field result = lue::create_array(array_shape, partition_shape, fill_value);
...
BOOST_AUTO_TEST_CASE(create_array_without_partition_shape)
{
    ...
    lue::Field result = lue::create_array(array_shape, fill_value);
