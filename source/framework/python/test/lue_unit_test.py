...
if __name__ == "__main__":
    ...
    hpx_arguments = [argument for argument in sys.argv[1:] if argument.startswith("--hpx")]

    # print(hpx_arguments)
    # os.environ["LUE_HPX_RUNTIME_CONFIGURATION"] = " ".join(hpx_arguments)
    # print(os.environ["LUE_HPX_RUNTIME_CONFIGURATION"])

    unittest_arguments = [argument for argument in sys.argv if not argument.startswith("--hpx")]
