...
namespace lue::framework {
    namespace {
        ...
        constexpr void define_logical_exclusive_or_overloads(pybind11::module& module)
        {
    ...
    {
        define_logical_exclusive_or_overloads<std::uint8_t>(module);
        define_logical_exclusive_or_overloads<std::uint32_t>(module);
        define_logical_exclusive_or_overloads<std::uint64_t>(module);
        define_logical_exclusive_or_overloads<std::int32_t>(module);
        define_logical_exclusive_or_overloads<std::int64_t>(module);
    }
