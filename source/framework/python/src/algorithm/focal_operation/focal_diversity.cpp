...
namespace lue::framework {
    namespace {
        ...
        template<typename Count, typename Element, Rank rank>
    ...
    void bind_focal_diversity(pybind11::module& module)
    {
        module.def(
            "focal_diversity",
            focal_diversity<std::uint64_t, std::uint8_t, 2>,
            "array"_a,
            "kernel"_a.noconvert());
        module.def(
            "focal_diversity",
            focal_diversity<std::uint64_t, std::int32_t, 2>,
            "array"_a,
            "kernel"_a.noconvert());
        module.def(
            "focal_diversity",
            focal_diversity<std::uint64_t, std::uint32_t, 2>,
            "array"_a,
            "kernel"_a.noconvert());
        module.def(
            "focal_diversity",
            focal_diversity<std::uint64_t, std::int64_t, 2>,
            "array"_a,
            "kernel"_a.noconvert());
        module.def(
            "focal_diversity",
            focal_diversity<std::uint64_t, std::uint64_t, 2>,
            "array"_a,
            "kernel"_a.noconvert());
    }
