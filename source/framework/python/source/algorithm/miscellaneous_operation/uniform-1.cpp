            ...
            switch (kind)
            {
                case 'i':
                {
                    ...
                    switch (size)
                    {
                        case 2:
                        {
                            result = uniform<std::int16_t>(array, min_value, max_value);
                            break;
                        }
                        case 4:
                        {
                ...
                case 'u':
                {
                    ...
                    switch (size)
                    {
                        case 2:
                        {
                            result = uniform<std::uint16_t>(array, min_value, max_value);
                            break;
                        }
                        case 4:
                        {
            ...
            switch (kind)
            {
                case 'i':
                {
                    ...
                    switch (size)
                    {
                        case 2:
                        {
                            result = uniform<std::int16_t>(min_value, max_value);
                            break;
                        }
                        case 4:
                        {
                ...
                case 'u':
                {
                    ...
                    switch (size)
                    {
                        case 2:
                        {
                            result = uniform<std::uint16_t>(min_value, max_value);
                            break;
                        }
                        case 4:
                        {
