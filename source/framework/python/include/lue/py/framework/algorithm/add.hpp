...
namespace lue::framework {
    ...
    auto add(Argument1 const& argument1, Argument2 const& argument2) -> PartitionedArray<Element, rank>
    {
    ...
    auto add(Argument1 const& argument1, Argument2 const& argument2) -> Scalar<Element>
    {
        return value_policies::add(argument1, argument2);
    }
