...
{
    auto callable =
        []([[maybe_unused]] lue::benchmark::Environment const& environment, lue::benchmark::Task const& task)
    {
        ...
        std::copy(task.array_shape().begin(), task.array_shape().end(), array_shape.begin());
