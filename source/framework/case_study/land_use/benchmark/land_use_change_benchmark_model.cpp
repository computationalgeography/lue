...
namespace lue {
    ...
    {
        std::copy(task.array_shape().begin(), task.array_shape().end(), _raster_shape.begin());

        std::copy(task.partition_shape().begin(), task.partition_shape().end(), _partition_shape.begin());
    }


    LandUseChangeBenchmarkModel::NominalRaster LandUseChangeBenchmarkModel::land_use() const
    {
    ...
    LandUseChangeBenchmarkModel::ScalarRaster LandUseChangeBenchmarkModel::elevation() const
    {
