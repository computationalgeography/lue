...
namespace lue {
    ...
    class WildfireModel final: public WildfireModelBase
    {

        public:

            WildfireModel(
                data_model::Count nr_time_steps,
        ...
        private:
            ...
            using ConstantRasterView = data_model::constant::RasterView<std::shared_ptr<data_model::Dataset>>;
            using VariableRasterView = data_model::variable::RasterView<std::shared_ptr<data_model::Dataset>>;
