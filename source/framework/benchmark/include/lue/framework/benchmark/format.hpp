...
namespace lue {
    namespace benchmark {
        ...
        */
        inline std::string to_iso_string(Stopwatch::SystemTimePoint const& time_point)
        {
            ...
            auto nr_bytes_written = std::strftime(buffer.data(), max_nr_characters, "%FT%T%z", time);
        ...
        */
        ...
        inline std::string format_as_json(Benchmark const& benchmark)
        {
        ...
        void to_json(nlohmann::json& json, AlgorithmBenchmarkResult const& result);
