...
namespace lue {
    namespace benchmark {
        ...
        */
        ...
        class BenchmarkBase
        {
            ...
            public:
                ...
                */
                ...
                bool hangs_rarely() const
                {
                    return _hangs_rarely;
                }
        ...
        // ----------------------------------------------------------------------------
        template<typename Callable, typename Result = void, typename Enable = void>
        class Benchmark: public BenchmarkBase<Callable>
        {
                // Use this when the callable does not return a result

            public:

                Benchmark(Callable&& callable, Environment const& environment, Task const& task):
