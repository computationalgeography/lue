...
namespace lue {
    namespace data_model {
        namespace test {
            ...
            template<typename T>
            inline void print(
                std::ostream& stream, std::vector<T> const& values, std::string const& separator)
            {
                if (!values.empty())
                {
                    std::copy(
                        values.begin(), --values.end(), std::ostream_iterator<T>(stream, separator.c_str()));
                    stream << values.back();
                }
            }
    ...
    namespace hdf5 {
        ...
        inline std::ostream& operator<<(std::ostream& stream, hdf5::Offset const& offset)
        {
            stream << "[";
        ...
        inline std::ostream& operator<<(std::ostream& stream, hdf5::Stride const& stride)
        {
            stream << "[";
        ...
        inline std::ostream& operator<<(std::ostream& stream, hdf5::Count const& count)
        {
            stream << "[";
        ...
        inline std::ostream& operator<<(std::ostream& stream, hdf5::Shape const& shape)
        {
            stream << "[";
        ...
        inline std::ostream& operator<<(std::ostream& stream, hdf5::Hyperslab const& hyperslab)
        {
            stream << "[";
        ...
        inline std::ostream& operator<<(std::ostream& stream, Datatype const& datatype)
        {
    ...
    namespace data_model {
        ...
        template<typename T>
        inline std::ostream& write(std::ostream& stream, Aspect<T> const& aspect)
        {
            stream << aspect.value();
...
#define STREAM_ASPECT(T)                                                                                     \
    inline std::ostream& operator<<(std::ostream& stream, T const kind)                                      \
    {                                                                                                        \
...
#undef STREAM_ASPECT
        ...
        inline std::ostream& write(std::ostream& stream, Aspect const& aspect, Aspects const&... aspects)
        {
            write(stream, aspect);
            stream << ", ";
        ...
        inline std::ostream& operator<<(std::ostream& stream, Configuration<Ts...> const& configuration)
        {
            return write(stream, configuration, std::index_sequence_for<Ts...>());
        }


        inline std::ostream& operator<<(std::ostream& stream, Clock const& clock)
        {
