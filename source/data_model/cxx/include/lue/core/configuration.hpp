...
namespace lue::data_model {
    ...
    inline void save([[maybe_unused]] hdf5::Attributes& attributes)
    {
    }
    ...
    class Configuration
    {
        ...
        public:
            ...
            */
            ...
            auto operator=(Configuration const& other) -> Configuration& = default;

            auto operator=(Configuration&& other) noexcept -> Configuration& = default;

            auto aspects() const -> std::tuple<Aspect<Ts>...>;
            ...
            */
            friend auto operator==(Configuration<Ts...> const& lhs, Configuration<Ts...> const& rhs) -> bool
            {
    ...
    */
    ...
    template<typename... Ts>
    inline auto Configuration<Ts...>::aspects() const -> std::tuple<Aspect<Ts>...>
    {
        return _aspects;
    }
    ...
    */
    template<typename... Ts>
    template<typename T>
    inline auto Configuration<Ts...>::value() const -> T
    {
