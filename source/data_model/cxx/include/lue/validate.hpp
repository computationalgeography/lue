...
namespace lue {
    namespace data_model {
        ...
        void assert_is_valid(Dataset const& dataset, bool fail_on_warning = true);

        void assert_is_valid(hdf5::File const& file, bool fail_on_warning = true);

        void assert_is_valid(std::string const& name, bool fail_on_warning = true);
