                ...
                */
                class LUE_DATA_MODEL_EXPORT Value: public ValueGroup
                {
                    ...
                    public:
                        ...
                        same_shape::constant_shape::Value expand(
                            ID id, hdf5::Shape const& shape, Count nr_locations_in_time);

                        same_shape::constant_shape::Value operator[](ID id) const;

                    private:

                        same_shape::constant_shape::Value expand_(
                            ID id, hdf5::Shape const& shape, Count nr_locations_in_time);
