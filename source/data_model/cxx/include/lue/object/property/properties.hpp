...
#undef COLLECTION
        ...
        template<>
        inline same_shape::Property& Properties::add<same_shape::Property>(
        ...
        template<>
        inline same_shape::constant_shape::Property& Properties::add<same_shape::constant_shape::Property>(
            std::string const& name, hdf5::Datatype const& datatype, std::string const& description)
        {
            verify_property_does_not_exist(name);
        ...
        template<>
        inline same_shape::variable_shape::Property& Properties::add<same_shape::variable_shape::Property>(
            std::string const& name,
            hdf5::Datatype const& datatype,
            Rank const rank,
            std::string const& description)
