#define BOOST_TEST_MODULE lue info space mobile_space_point
...
class Fixture: public lue::data_model::test::FileFixture
{
    ...
    public:
        ...
        Fixture():
            ...
            _value{std::make_unique<lue::data_model::MobileSpacePoint>(
                lue::data_model::create_mobile_space_point(*_file, _datatype, _rank))}
        {
        }
    ...
    private:
        ...
        std::unique_ptr<lue::data_model::MobileSpacePoint> _value;
};
...
BOOST_FIXTURE_TEST_CASE(create, Fixture)
{
    ...
    BOOST_CHECK(value.array_shape() == lh5::Shape{static_cast<lh5::Shape::value_type>(rank())});
}
