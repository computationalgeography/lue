...
class Fixture: public lue::data_model::test::FileFixture
{
    ...
    public:
        ...
        Fixture():
            ...
            _property{std::make_unique<lue::data_model::same_shape::Property>(
                lue::data_model::same_shape::create_property(*_file, _name, _datatype, _array_shape))}
        {
        }
    ...
    private:
        ...
        std::unique_ptr<lue::data_model::same_shape::Property> _property;
};
