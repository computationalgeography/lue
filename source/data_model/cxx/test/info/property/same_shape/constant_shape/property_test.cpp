...
public:
    ...
    Fixture():
        ...
        _property{std::make_unique<lue::same_shape::constant_shape::Property>(
            lue::same_shape::constant_shape::create_property(
...
private:
    ...
    std::unique_ptr<lue::same_shape::constant_shape::Property> _property;
