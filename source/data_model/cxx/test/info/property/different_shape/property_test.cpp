...
class Fixture: public lue::data_model::test::FileFixture
{
    ...
    public:
        ...
        Fixture():
            ...
            _property{std::make_unique<lue::data_model::different_shape::Property>(
                lue::data_model::different_shape::create_property(*_file, _name, _datatype, _rank))}
        {
        }
    ...
    private:
        ...
        std::unique_ptr<lue::data_model::different_shape::Property> _property;
};
