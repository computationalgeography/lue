        ...
        namespace different_shape {
            namespace constant_shape {
                ...
                */
                ...
                bool Value::exists(ID const id) const
                {
                ...
                */
                same_shape::constant_shape::Value Value::expand(
                    ID const id, hdf5::Shape const& shape, Count const nr_locations_in_time)
                {
                ...
                same_shape::constant_shape::Value Value::operator[](ID const id) const
                {
                    std::string const name{std::to_string(id)};
