...
namespace lue::data_model::different_shape::variable_shape {
    ...
    */
    ...
    /*!
        ...
        @return     An instance representing the collection of object arrays. It can be used to write object
                    information.
    */
    auto Value::expand(Index const idx, Count const nr_objects, ID const* ids, hdf5::Shape const* shapes)
    ...
    auto Value::operator[](Index const idx) -> different_shape::Value
    {
        std::string const name{std::to_string(idx)};
