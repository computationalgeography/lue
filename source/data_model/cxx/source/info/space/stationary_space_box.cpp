...
namespace lue::data_model {
    ...
    StationarySpaceBox::StationarySpaceBox(hdf5::Group const& parent):
    ...
    StationarySpaceBox::StationarySpaceBox(hdf5::Group const& parent, hdf5::Datatype const& memory_datatype):
    ...
    StationarySpaceBox::StationarySpaceBox(same_shape::Value&& value):
    ...
    auto StationarySpaceBox::nr_boxes() const -> Count
    {
        return nr_arrays();
    }
    ...
    auto create_stationary_space_box(
        ...
        std::size_t const rank) -> StationarySpaceBox
    {
