...
namespace lue::data_model {
    namespace {
        ...
        auto read_epoch(hdf5::Attributes const& attributes) -> time::Epoch
        {
            time::Epoch epoch{};
            auto const kind =
        ...
        auto read_clock(hdf5::Attributes const& attributes) -> Clock
        {
    ...
    auto TimeDomain::configuration() const -> TimeConfiguration const&
    {
        return _configuration;
    }


    auto TimeDomain::clock() const -> Clock const&
    {
        return _clock;
    }
