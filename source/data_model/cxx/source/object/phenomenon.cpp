...
namespace lue::data_model {
    ...
    auto Phenomenon::description() const -> std::string const&
    {
        return _description;
    }
    ...
    */
    auto Phenomenon::object_id() const -> ObjectID const&
    {
        return _object_id;
    }
    ...
    /*!
        @brief      Return ID instance storing object IDs
    */
    auto Phenomenon::object_id() -> ObjectID&
    {
        return _object_id;
    }
    ...
    /*!
        ...
        @exception  .
    */
    auto Phenomenon::collection_property_sets() const -> PropertySets const&
    {
        return _collection_property_sets;
    }


    auto Phenomenon::collection_property_sets() -> PropertySets&
    {
        return _collection_property_sets;
    }


    auto Phenomenon::property_sets() const -> PropertySets const&
    {
        return _property_sets;
    }


    auto Phenomenon::property_sets() -> PropertySets&
    {
        return _property_sets;
    }
