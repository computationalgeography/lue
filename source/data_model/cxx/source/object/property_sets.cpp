...
namespace lue {
    namespace data_model {
        ...
        PropertySet& PropertySets::add(std::string const& name)
        {
        ...
        PropertySet& PropertySets::add(std::string const& name, TimeDomain& domain)
        {
        ...
        PropertySet& PropertySets::add(
            std::string const& name, TimeDomain& domain, ObjectTracker& object_tracker)
        {
