...
Property::Property(
    ...
    _value{std::forward<same_shape::variable_shape::Value>(value)}

{
}


same_shape::variable_shape::Value const& Property::value() const
{
    return _value;
}


same_shape::variable_shape::Value& Property::value()
{
    return _value;
}
