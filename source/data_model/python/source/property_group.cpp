...
namespace lue {
    namespace data_model {
        ...
        py::object property_new(Properties& properties, std::string const& name);
    ...
    Space discretization can be regular grid
            ...
            py::class_<PropertyGroup, hdf5::Group>(module, "PropertyGroup")
    ...
    :param PropertyGroup property: Discretization property
                ...
                .def_property_readonly("time_is_discretized", &PropertyGroup::time_is_discretized)

                .def_property_readonly("space_is_discretized", &PropertyGroup::space_is_discretized)
                ...
                .def(
                    ...
                    [](PropertyGroup& property)
                    {
                        ...
                        // New, local instance.
                        auto property_set = PropertySet{data_model::property_set(discretization_property)};

                        assert(property_set.properties().contains(discretization_property.name()));
