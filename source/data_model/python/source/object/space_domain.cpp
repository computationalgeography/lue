...
namespace lue {
    namespace data_model {
        namespace {
            ...
            static std::string informal_string_representation(SpaceConfiguration const& configuration)
            {
            ...
            static std::string informal_string_representation(SpaceDomain const& domain)
            {
    ...
    Class for representing the aspects of the spatial domain
                ...
                .def(py::init<Mobility, SpaceDomainItemType>())
                ...
                .def_property_readonly("mobility", &SpaceConfiguration::value<Mobility>)

                .def_property_readonly("item_type", &SpaceConfiguration::value<SpaceDomainItemType>)
    ...
    TODO
                ...
                .def(
                    "__repr__",
                    [](SpaceDomain const& domain) { return formal_string_representation(domain); })

                .def(
                    "__str__",
                    [](SpaceDomain const& domain) { return informal_string_representation(domain); })

                .def("set_presence_discretization", &SpaceDomain::set_presence_discretization)

                .def_property_readonly("presence_is_discretized", &SpaceDomain::presence_is_discretized)

                .def_property_readonly(
                    "discretized_presence_property", &SpaceDomain::discretized_presence_property)
