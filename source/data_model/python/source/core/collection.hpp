...
#define BASE_COLLECTION(Items, Item)                                                                         \
    ...
    py::class_<Item##Collection, hdf5::Group>(module, #Item "Collection")                                    \
        ...
        .def(                                                                                                \
            ...
            { return #Items "(size=" + std::to_string(collection.size()) + ")"; })                           \
                                                                                                             \
        .def_property_readonly(                                                                              \
            "names", &Item##Collection::names, "Return collection of names of objects in collection\n")      \
                                                                                                             \
        .def(                                                                                                \
            "__contains__",                                                                                  \
            [](Item##Collection const& collection, std::string const& name)                                  \
        ...
        .def(                                                                                                \
            "__getitem__",                                                                                   \
            py::overload_cast<std::string const&>(&Item##Collection::operator[]),                            \
            "Return object\n"                                                                                \
            "\n"                                                                                             \
            ":param str name: Name of object to find\n"                                                      \
