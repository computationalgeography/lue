    ...
    [[maybe_unused]] pybind11::module& module)
{
    ...
    pybind11::class_<RasterViewBase, DatasetView<Dataset*>>(
        module,
        "RasterView");

    {
        ...
        pybind11::class_<ConstantRasterView, RasterViewBase>(
            submodule,
            "RasterView")
...

    {
        ...
        pybind11::class_<VariableRasterView, RasterViewBase>(
            submodule,
            "RasterView")
    ...
    module.def(
            ...
            typename RasterViewBase::SpaceBox const& space_box)
        {
            ...
            return variable::create_raster_view<Dataset*>(
                &dataset, phenomenon_name, property_set_name, clock,
                nr_time_steps, time_box, grid_shape_, space_box);
        },
        // Keep the dataset (arg 1) alive as long as the view (arg 0)
        // is alive
        pybind11::keep_alive<0, 1>());
