...
options:
    ...
    -m <name> --meta=<name>  File containing metadata to use during export
)";
    ...
    int Export::run_implementation()
    {
        ...
        std::string const file_extension{std::filesystem::path(output_dataset_name).extension()};
        ...
        {
            translate_lue_dataset_to_netcdf4(*lue_dataset, output_dataset_name, metadata);
        }
