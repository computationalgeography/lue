...
namespace lue {
    namespace hdf5 {
        namespace {
            ...
            inline Collection difference(Collection collection1, Collection collection2)
            {
        ...
        bool assert_groups_exist(Group const& group, std::vector<std::string> const& names, Issues& issues)
        {
