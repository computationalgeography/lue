    ...
    namespace hdf5 {
        namespace {
            ...
            extern "C" ::herr_t error_walker(
                unsigned int /* idx */, ::H5E_error2_t const* error, void* client_data);


            ::herr_t error_walker(unsigned int /* idx */, ::H5E_error2_t const* error, void* client_data)
            {
        ...
        ErrorStack::ErrorStack(Identifier const& id):
