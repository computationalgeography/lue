        ...
        */
        ...
        /*!
            ...
            @exception  std::runtime_error In case the dataspace cannot be
                        created
            @sa
           [H5Screate_simple](https://support.hdfgroup.org/HDF5/doc/RM/RM_H5S.html#Dataspace-CreateSimple)
        */
        Dataspace create_dataspace(Shape const& dimension_sizes, Shape const& max_dimension_sizes)
        {
            ...
            Identifier dataspace_location(
                ::H5Screate_simple(
                    static_cast<int>(dimension_sizes.size()),
                    dimension_sizes.data(),
                    max_dimension_sizes.data()),
                H5Sclose);
