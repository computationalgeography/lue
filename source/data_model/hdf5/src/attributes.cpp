    ...
    namespace hdf5 {
        ...
        */
        Attribute Attributes::add(
            std::string const& name, Datatype const& datatype, Dataspace const& dataspace)
        {
        ...
        */
        bool Attributes::exists(std::string const& name) const
        {
        ...
        */
        Attribute Attributes::attribute(std::string const& name) const
        {
            assert(_id.is_valid());
        ...
        */
        Datatype Attributes::datatype(std::string const& name) const
        {
