#define BOOST_TEST_MODULE lue item different_shape constant_shape constant_collection synchronous_value
...
BOOST_AUTO_TEST_CASE(create_collection)
{
    ...
    collection.reserve(nr_items, nr_time_domain_items, value_shapes.data());
