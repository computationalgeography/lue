...
def post_process_raw_results(
    ...
    def plot_duration(
        ...
        linear_duration = np.array([duration[0] / nr_workers[n] for n in range(len(nr_workers))])
        axis.plot(
    ...
    def plot_relative_speed_up(
        ...
        serial_relative_speed_up = np.array([relative_speed_up[0] for n in range(len(nr_workers))])
        axis.plot(
    ...
    def plot_relative_efficiency(
        ...
        linear_relative_efficiency = np.array([relative_efficiency[0] for n in range(len(nr_workers))])
        axis.plot(
...
def postprocess_results(
    ...
    performance_counters_available = "performance_counter_1" in lue_dataset.benchmark.property_sets.names
