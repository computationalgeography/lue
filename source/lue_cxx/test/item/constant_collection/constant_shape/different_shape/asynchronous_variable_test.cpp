#define BOOST_TEST_MODULE lue item constant_collection constant_shape different_shape asynchronous_variable
...
BOOST_AUTO_TEST_CASE(create_collection)
{
    ...
    auto collection = different_shape::create_asynchronous_variable(
