#define BOOST_TEST_MODULE lue item constant_size constant_shape different_shape constant
...
BOOST_AUTO_TEST_CASE(create_collection)
{
    ...
    auto collection =
        lue::constant_size::constant_shape::different_shape::create_constant(
