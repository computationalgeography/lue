...
public:
    ...
    Fixture():
        ...
        _property{std::make_unique<lue::different_shape::constant_shape::Property>(
            lue::different_shape::constant_shape::create_property(
...
private:
    ...
    std::unique_ptr<lue::different_shape::constant_shape::Property> _property;
