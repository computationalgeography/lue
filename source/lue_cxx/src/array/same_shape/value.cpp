...
/*!
    @brief      Reserve space for @a nr_objects object arrays
*/
void Value::reserve(
    hsize_t const nr_objects)
{
...
/*!
    @brief      Return number of objects for which arrays are stored
*/
hsize_t Value::nr_objects() const
{
    return shape()[0];
}
