    ...
    namespace view {
        namespace {
                ...
                data_model::same_shape::Value const& value, bool const show_details)
            {
                ...
                {
                    if (auto tab_bar = imgui::TabBar("Values"))
                    {
                        LUE_UNUSED(tab_bar);
                        ...
                        // TODO Maybe popup a new window with a table with values?
                        // Would be nice to be able to view multiple of
                        // them and select an ID and all the values.
                        ...
                        if (rank == 0)
                        {
                            ...
                            if (auto tab_item = imgui::TabItem("Table"))
                            {
                                LUE_UNUSED(tab_item);
            ...
            void show_properties(data_model::Properties const& properties, bool const show_details)
            {
                ...
                if (!collection.empty())
                {
                    ...
                    {
                        if (auto tree_node = imgui::TreeNode(name, ImGuiTreeNodeFlags_DefaultOpen))
                        {
            ...
            void show_properties2(data_model::Properties const& properties, bool const show_details)
            {
                ...
                {
                    if (auto tab_item = imgui::TabItem(property_name))
                    {
                        LUE_UNUSED(tab_item);
            ...
            void show_property_set(data_model::PropertySet const& property_set, bool const show_details)
            {
                ...
                {
                    if (auto tree_node = imgui::TreeNode("object tracker"))
                    {
                    ...
                    if (auto tree_node = imgui::TreeNode("time domain", ImGuiTreeNodeFlags_DefaultOpen))
                    {
                        LUE_UNUSED(tree_node);
                ...
                {
                    if (auto tree_node = imgui::TreeNode("space domain", ImGuiTreeNodeFlags_DefaultOpen))
                    {
                        LUE_UNUSED(tree_node);
...

                {
                            ...
                            ImGuiTreeNodeFlags_DefaultOpen))
                    {
                        ...
                        if (auto tab_bar = imgui::TabBar("Properties"))
                        {
                            LUE_UNUSED(tab_bar);
            ...
            {
                if (auto tab_bar = imgui::TabBar("Property-sets"))
                {
                    LUE_UNUSED(tab_bar);

                    for (std::string const& name : property_sets.names())
                    {
                        if (auto tab_item = imgui::TabItem(name))
                        {
                            LUE_UNUSED(tab_item);
            ...
            {
                if (auto tab_bar = imgui::TabBar("Phenomena"))
                {
                    LUE_UNUSED(tab_bar);
            ...
            {
                if (auto tree_node = imgui::TreeNode("phenomena", ImGuiTreeNodeFlags_DefaultOpen))
                {
                    LUE_UNUSED(tree_node);
            ...
            {
                if (auto tab_bar = imgui::TabBar("Universes"))
                {
                    LUE_UNUSED(tab_bar);
        ...
        void show_datasets(Datasets& datasets, bool const show_details)
        {
            ...
            for (auto& dataset : datasets)
            {
                ...
                {
                    if (auto window = imgui::Window{dataset.filename(), &open[dataset.pathname()]})
                    {
            ...
            // imgui::Window imgui_window{"Datasets"};

            // if(auto tab_bar = imgui::TabBar("Datasets"))
            // {
            //     LUE_UNUSED(tab_bar);

            //     for(auto& dataset: datasets)
            //     {
            //         if(auto tab_item = imgui::TabItem(dataset.filename()))
            //         {
            //             LUE_UNUSED(tab_item);
