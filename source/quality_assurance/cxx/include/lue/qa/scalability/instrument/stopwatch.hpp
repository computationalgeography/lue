    ...
    class Stopwatch
    {
        ...
        public:
            ...
            /*!
                ...
                Use this function to convert the high resolution duration to some courser unit, like seconds.

                @code{.cpp}
                auto const nr_seconds = stopwatch.duration<std::chrono::seconds>().count();
                @endcode
            */
