...
DescribeFlowDirection::DescribeFlowDirection(
...
int DescribeFlowDirection::run_implementation()
{
    ...
    // is performed!
    {
        auto input_dataset_ptr = std::make_shared<ldm::Dataset>(
            ldm::open_dataset(input_dataset_pathname, H5F_ACC_RDONLY));
    ...
    using FlowDirectionPolicies = policy::InputPolicies<policy::DetectNoDataByValue<FlowDirectionElement>>;
    ...
    InflowCountPolicies inflow_count_policies{
        policy::MarkNoDataByValue<InflowCountElement>{}};
    ...
    // FlowDirectionPolicies flow_direction_policies{lue::policy::DetectNoDataByValue<FlowDirectionElement>{}};
    ...
    {
        auto output_dataset_ptr = std::make_shared<ldm::Dataset>(
            ldm::create_dataset(output_dataset_pathname));
...

    {
        ...
        array_pathname = fmt::format("{}/{}/{}/{}",
            output_dataset_pathname, phenomenon_name, property_set_name, "flow_direction");
        arrays_written.push_back(write_into(flow_direction_array, array_pathname, object_id));

        array_pathname = fmt::format("{}/{}/{}/{}",
            output_dataset_pathname, phenomenon_name, property_set_name, "inflow_count");
        arrays_written.push_back(write_into(inflow_count_array, array_pathname, object_id));

        array_pathname = fmt::format("{}/{}/{}/{}",
            output_dataset_pathname, phenomenon_name, property_set_name, "inter_partition_stream");
