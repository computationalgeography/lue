...
if(LUE_FMT_REQUIRED)
    if(NOT LUE_HAVE_FMT)
        ...
        set(LUE_CONAN_OPTIONS ${LUE_CONAN_OPTIONS} fmt:header_only=True)
    endif()
endif()
...
if(LUE_MS_GSL_REQUIRED)
    if(NOT LUE_HAVE_MS_GSL)
        ...
        set(LUE_CONAN_OPTIONS ${LUE_CONAN_OPTIONS} ms-gsl:header_only=True)
    endif()
endif()
...
if(LUE_NLOHMANN_JSON_REQUIRED)
    if(NOT LUE_HAVE_NLOHMANN_JSON)
        ...
        set(LUE_CONAN_OPTIONS ${LUE_CONAN_OPTIONS} nlohmann_json:header_only=True)
    endif()
endif()
